        ...
        <section id='rubbish-clearance' className='relative overflow-hidden bg-[#B9DCF5]/30'>
            ...
            <div className='container relative z-10 mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8 lg:py-14'>
                <div className='max-w-6xl'>
                    <h2 className='text-2xl font-bold leading-tight text-[#11224D] sm:text-3xl'>Rubbish Clearance Services</h2>
                    ...
                    <a
                        ...
                        className='group mt-6 flex w-full items-center justify-center gap-2 rounded-md bg-[#11224D] px-4 py-3 text-center text-sm font-bold uppercase leading-snug text-white transition-colors hover:bg-[#0D3A66] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#11224D] sm:px-6 sm:text-base lg:text-lg'
                    >
                    ...
                    <div className='mt-5 grid grid-cols-1 gap-x-8 gap-y-3 sm:grid-cols-1 lg:mt-6 lg:grid-cols-2 lg:gap-x-12'>
                        {benefits.map((benefit) => (
                            <div key={benefit} className='flex min-w-0 items-start gap-2.5 group hover:bg-[#11224D]/30 hover:shadow-xl hover:translate-x-1 px-4 py-1 w-fit rounded-lg'>
                                <Check aria-hidden='true' className='mt-0.5 size-5 shrink-0 text-[#11224D] sm:size-6 group-hover:scale-110' strokeWidth={3}/>
