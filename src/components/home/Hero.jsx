...
export default function Hero () {
  return (
    <div className='relative h-[34rem] w-full overflow-hidden sm:h-[36rem] md:h-[40rem] lg:h-[48rem] xl:h-[50rem]'>
        <Image src="/images/Hero2.jpg" alt="garbage" fill sizes="100vw" className="object-cover" priority/>
