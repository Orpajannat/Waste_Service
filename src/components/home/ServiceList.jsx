      ...
      <div className='relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mt-12 grid grid-cols-1 gap-5 sm:mt-14 sm:grid-cols-2 lg:grid-cols-3 lg:gap-6'>
          {services.map((service, index) => (
            <article key={service.title} className='group flex min-w-0 flex-col overflow-hidden rounded-[1.75rem] border border-[#11224D]/10 bg-white shadow-sm transition-all duration-500 hover:-translate-y-2 hover:border-[#0497E2]/30 hover:shadow-2xl hover:shadow-[#11224D]/10'>
              <div className='relative m-2 mb-0 aspect-[16/10] overflow-hidden rounded-[1.3rem] bg-[#DDEAF1]'>
                ...
                />
                <div className='absolute inset-0 bg-linear-to-t from-[#07142E]/45 via-transparent to-transparent opacity-70 transition-opacity duration-500 group-hover:opacity-40' />
                ...
                <span className='absolute bottom-4 left-4 rounded-full bg-[#11224D]/80 px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.16em] text-white backdrop-blur transition-colors duration-300 group-hover:bg-[#0497E2]'>
                  {service.eyebrow}
                </span>
              </div>
              ...
              <div className='flex flex-1 flex-col p-5 sm:p-6'>
                ...
                <Link href={service.href} className='group/link mt-6 flex items-center justify-between gap-4 border-t border-[#11224D]/10 pt-4 text-sm font-black text-[#11224D] transition-colors duration-300 hover:text-[#0497E2] focus-visible:outline-none focus-visible:text-[#0497E2]'>
                  Explore this service
                  <span className='flex size-10 shrink-0 items-center justify-center rounded-full bg-[#11224D] text-white transition-all duration-300 group-hover/link:translate-x-1 group-hover/link:bg-[#0497E2] group-focus-visible/link:translate-x-1 group-focus-visible/link:bg-[#0497E2]'>
        ...
        <div className='mt-10 flex flex-col gap-5 rounded-[2rem] bg-[#11224D] p-6 text-white shadow-xl sm:flex-row sm:items-center sm:justify-between sm:p-8 lg:px-10'>
          <div>
