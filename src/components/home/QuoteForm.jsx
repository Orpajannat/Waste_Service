    ...
    <section id='form' className='relative overflow-hidden bg-linear-to-br from-[#0497E2] via-[#1679BA] to-[#0492E8] py-16 text-white sm:py-20 lg:py-28'>
      ...
      <div className='relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        <div className='mx-auto max-w-5xl text-center'>
          <span className='inline-flex rounded-full border border-white/20 bg-white/10 px-4 py-2 text-xs font-black uppercase tracking-[0.22em] text-white shadow-sm backdrop-blur'>
          ...
          <div className='mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row'>
            ...
            <a href='tel:02082266477' className='group inline-flex w-full items-center justify-center gap-3 rounded-full border border-white/30 bg-white/10 px-6 py-4 text-sm font-black text-white backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:border-white hover:bg-white/20 hover:shadow-xl focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white sm:w-auto sm:text-base'>
            ...
            return (
              <article key={step.title} className='group relative overflow-hidden rounded-[1.75rem] border border-white/15 bg-[#0492E8]/25 p-5 text-left shadow-sm backdrop-blur-md transition-all duration-500 hover:-translate-y-2 hover:border-white/35 hover:bg-[#0492E8]/40 hover:shadow-2xl sm:p-6'>
                <div className='flex items-start justify-between gap-4'>
                  ...
                  <span className='text-xs font-black tracking-[0.18em] text-white/35'>{String(index + 1).padStart(2, '0')}</span>
                </div>
                <h3 className='mt-7 text-xl font-black text-white sm:text-2xl'>{step.title}</h3>
                <p className='mt-3 text-sm leading-6 text-white/65 sm:text-base'>{step.text}</p>
        ...
        <div className='mt-8 flex flex-col gap-4 border-t border-white/15 pt-6 text-sm text-white/65 sm:flex-row sm:items-center sm:justify-between'>
          ...
          <p className='font-semibold text-white'>Friendly support · Clear options · No pressure</p>
        </div>
      </div>
    </section>
  )
