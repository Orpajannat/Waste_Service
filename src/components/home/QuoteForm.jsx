...
export default function QuoteForm() {
  return (
    <section id="form" className='relative overflow-hidden bg-[#077F7F]'>
      <div
        aria-hidden='true'
      ...
      <div className='relative z-10 mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 sm:py-12 lg:px-8 lg:py-16'>
        ...
        <form className='mt-7 space-y-4 sm:mt-8'>
          <div className='grid gap-4 md:grid-cols-3'>
            ...
            <input
              className='min-h-12 w-full rounded-md border border-white/30 bg-white px-4 text-[#153933] outline-none transition placeholder:text-neutral-500 focus:border-[#29B380] focus:ring-4 focus:ring-[#29B380]/25'
              id='quote-name'
              name='name'
              placeholder='Name'
              type='text'
          ...
          <textarea
            className='min-h-32 w-full resize-y rounded-md border border-white/30 bg-white p-4 text-[#153933] outline-none transition placeholder:text-neutral-500 focus:border-[#29B380] focus:ring-4 focus:ring-[#29B380]/25'
            id='quote-question'
            name='question'
          ...
          <label className='mx-auto flex max-w-max cursor-pointer items-start gap-3 py-2 text-sm leading-6 text-white sm:items-center sm:text-base'>
            <input
              className='mt-1 size-4 shrink-0 accent-[#29B380] sm:mt-0'
              name='privacy-policy'
              type='checkbox'
              required
            />
            <span>
              ...
              <a className='font-semibold text-[#A7DDD2] underline underline-offset-2 hover:text-white' href='/privacy-policy'>
                Privacy Policy
              </a>
          ...
          <button
            className='min-h-12 w-full rounded-md bg-[#29B380] px-6 text-lg font-bold text-[#153933] transition hover:bg-[#A7DDD2] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-white/40 active:scale-[0.99] sm:text-xl'
            type='submit'
          >
            SEND
          </button>
