...
export default function AboutUs() {
  ...
  return (
    <section className="relative overflow-hidden bg-white px-5 py-20 sm:px-8 lg:px-14 xl:px-20 bg-linear-to-b from-[#FFFFFF] to-[#E9F4FC]">
      ...
      <div className="absolute -left-32 top-20 h-80 w-80 rounded-full bg-[#11224D]/5 blur-3xl" />
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="grid items-center gap-14 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="group relative">
            ...
            <div className="absolute -left-5 -top-5 hidden h-24 w-24 rounded-full border-2 border-[#11224D]/10 transition-all duration-700 group-hover:scale-125 group-hover:border-[#11224D]/30 lg:block" />

            <div className="absolute -bottom-8 -right-8 hidden h-28 w-28 rounded-full bg-[#11224D]/5 transition-all duration-700 group-hover:scale-125 group-hover:bg-[#11224D]/10 lg:block" />

            <div className="relative overflow-hidden rounded-[2rem] border-[10px] border-white bg-white shadow-2xl shadow-[#11224D]/10 transition-all duration-700 group-hover:-translate-y-2 group-hover:shadow-2xl group-hover:shadow-[#11224D]/20">
              ...
              <div className="relative aspect-[4/3] overflow-hidden rounded-[1.4rem]">
                ...
                <div className="absolute inset-0 bg-gradient-to-tr from-[#11224D]/50 via-transparent to-transparent opacity-60 transition-all duration-700 group-hover:opacity-30" />

                <div className="absolute inset-0 bg-[#11224D]/0 transition-all duration-700 group-hover:bg-[#11224D]/10" />
            ...
            <div className="absolute -bottom-6 left-8 rounded-2xl bg-[#11224D] px-6 py-4 text-white shadow-xl shadow-[#11224D]/25 transition-all duration-500 hover:-translate-y-2 hover:scale-105 hover:shadow-2xl hover:shadow-[#11224D]/30">
          ...
          <div>
            ...
            <div className="mb-5 inline-flex items-center gap-3">
              ...
              <span className="h-[2px] w-10 bg-[#11224D] transition-all duration-500 hover:w-16" />
            ...
            <div className="mt-6 h-1 w-16 rounded-full bg-[#11224D] transition-all duration-500 hover:w-32" />
            ...
            <div className="mt-7 space-y-3">
              ...
              {[
                ...
                <div
                  key={item}
                  className="group flex cursor-pointer items-center gap-3 rounded-xl p-2 transition-all duration-300 hover:translate-x-2 hover:bg-[#11224D]/5"
                >
            ...
            <div className="mt-9 grid gap-4 sm:grid-cols-3">
              ...
              {features.map((feature) => {
                ...
                return (
                  <div
                    key={feature.title}
                    className="group cursor-pointer rounded-2xl border border-slate-100 bg-white p-4 shadow-sm transition-all duration-500 hover:-translate-y-2 hover:border-[#11224D]/20 hover:bg-[#11224D] hover:shadow-xl hover:shadow-[#11224D]/20"
                  >

                    <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl bg-[#11224D]/10 transition-all duration-500 group-hover:rotate-6 group-hover:scale-110 group-hover:bg-white/10">
            ...
            <div className="mt-8 inline-flex cursor-pointer items-center gap-3 text-sm font-bold text-[#11224D]">
              ...
              <span className="relative">
                ...
                <span className="absolute -bottom-1 left-0 h-[2px] w-0 bg-[#11224D] transition-all duration-500 hover:w-full" />
              </span>

              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#11224D] text-white transition-all duration-500 hover:rotate-45 hover:scale-110 hover:bg-blue-600">
