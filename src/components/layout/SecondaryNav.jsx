        ...
        <div className='container mx-auto grid grid-cols-1 gap-px px-4 py-5 sm:grid-cols-2 sm:px-6 md:py-6 lg:grid-cols-4 lg:px-8'>
            {secondaryNav.map((nav) => {
                ...
                return (
                    ...
                    href="#form"
                    key={nav.id}
                    className='group flex min-h-20 min-w-0 items-center gap-4 rounded-lg border-white/25 px-3 py-4 transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#11224D] hover:shadow-lg focus-within:bg-[#11224D] sm:min-h-24 sm:px-5 sm:odd:border-r lg:min-h-28 lg:border-r lg:px-6 lg:last:border-r-0'>
