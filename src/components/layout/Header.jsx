...
export default function Header () {
  return (
    <header className='sticky top-0 z-50 right-0 left-0 flex flex-col'>
        <div className='bg-white container mx-auto flex min-w-full flex-col px-4 py-5 sm:px-6 md:py-7 lg:flex-row lg:items-center lg:justify-evenly lg:gap-8 lg:px-8'>
            <Image
            ...
            <div className='mt-5 flex min-w-0 flex-col gap-3 sm:mx-auto sm:w-fit md:flex-row md:items-end md:gap-7 lg:mx-0 lg:mt-0 lg:items-baseline'>
                <div className='flex min-w-0 flex-col items-start lg:items-center'>
                    ...
                    <h2 className='mt-1 text-lg leading-tight text-[#077F7F] sm:text-xl'>Serving The Home Counties</h2>
                </div>
                <div className='flex shrink-0 flex-col items-start justify-between lg:items-center'>
                    ...
                    <button className='group mt-3 flex flex-row items-center gap-2 rounded-md bg-[#077F7F] px-4 py-2 font-semibold uppercase text-white transition-colors hover:bg-[#0B3E43] sm:px-6 lg:rounded-lg lg:px-8 lg:normal-case'>
                        Prices &amp; Book
