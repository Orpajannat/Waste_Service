      ...
      <div className='container mx-auto grid gap-10 px-4 py-12 sm:px-6 md:grid-cols-2 lg:grid-cols-[1.2fr_1fr_1fr_1.35fr] lg:px-8 lg:py-16'>
        <div>
          <Link href='/' className='inline-flex items-center gap-3' aria-label='Waste Services home'>
            <Image src="/images/SecondLogo.png" alt="Logo" width={150} height={50}/>
          </Link>
          ...
          <div className='mt-6 flex gap-3'>
            <a href='#' aria-label='Facebook' className='rounded-full border border-white/20 p-2.5 transition hover:border-[#1A68A3] hover:bg-[#1A68A3]'>
              <MessageCircle aria-hidden='true' size={18} />
            </a>
            <a href='#' aria-label='Instagram' className='rounded-full border border-white/20 p-2.5 transition hover:border-[#1A68A3] hover:bg-[#1A68A3]'>
        ...
        <div>
          ...
          <div className='mt-5 space-y-4 text-sm text-white/75'>
            <a href='tel:02082266477' className='flex items-center gap-3 transition hover:text-white'>
              <Phone aria-hidden='true' className='shrink-0 text-[#1A68A3]' size={19} />
              020 8226 6477
            </a>
            <a href='mailto:info@wasteservices.com' className='flex items-center gap-3 transition hover:text-white'>
              <Mail aria-hidden='true' className='shrink-0 text-[#1A68A3]' size={19} />
              info@wasteservices.com
            </a>
            <p className='flex items-start gap-3'>
              <MapPin aria-hidden='true' className='mt-0.5 shrink-0 text-[#1A68A3]' size={19} />
              Serving the Home Counties
            </p>
            <p className='flex items-start gap-3'>
              <Clock3 aria-hidden='true' className='mt-0.5 shrink-0 text-[#1A68A3]' size={19} />
        ...
        {links.map((link) => (
          <li key={link}>
            <a href='#' className='group inline-flex items-center gap-2 transition hover:text-white'>
              <ArrowUpRight aria-hidden='true' size={15} className='text-[#1A68A3] transition group-hover:translate-x-0.5 group-hover:-translate-y-0.5' />
              {link}
            </a>
          </li>
        ))}
