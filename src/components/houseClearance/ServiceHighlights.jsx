    ...
    <section className='bg-[#077F7F]'>
      <div className='mx-auto grid w-full max-w-7xl grid-cols-1 gap-3 px-4 py-5 sm:grid-cols-2 sm:px-6 sm:py-6 lg:grid-cols-4 lg:gap-4 lg:px-8'>
        {highlights.map(({ title, icon: Icon }) => (
          <div
            key={title}
            className='group flex min-h-28 items-center gap-4 rounded-xl border border-white/10 px-4 py-4 transition duration-300 hover:-translate-y-1 hover:border-[#A7DDD2]/50 hover:bg-white/10 hover:shadow-lg sm:min-h-32 lg:px-3'
          >
            <div className='flex size-16 shrink-0 items-center justify-center rounded-lg bg-white text-[#077F7F] shadow-sm transition duration-300 group-hover:scale-105 group-hover:bg-[#A7DDD2] sm:size-18 lg:size-16 xl:size-20'>
