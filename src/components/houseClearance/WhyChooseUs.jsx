      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-16">
          <div className="group relative min-h-[360px] overflow-hidden rounded-[2rem] bg-[#102a4c] shadow-[0_28px_65px_-35px_rgba(16,42,76,0.65)] sm:min-h-[380px]">
            ...
            <div className="absolute inset-x-5 bottom-5 rounded-2xl border border-white/20 bg-[#071d3b]/82 p-5 text-white shadow-lg backdrop-blur-md sm:inset-x-7 sm:bottom-7 sm:p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-white/75">of collected waste is recycled</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="mt-8 grid gap-x-6 gap-y-3 sm:grid-cols-2" aria-label="Reasons to choose London Waste Services">
              {benefits.map((benefit) => (
                ...
                >
                  <span className="grid size-7 shrink-0 place-items-center rounded-full bg-[#102a4c] text-white transition duration-300 group-hover/item:bg-[#f0aa26] group-hover/item:text-[#102a4c]">
        ...
        <div className="group relative isolate mt-16 min-h-[360px] overflow-hidden rounded-[2rem] bg-[#102a4c] shadow-[0_28px_70px_-38px_rgba(16,42,76,0.75)] lg:mt-24 lg:min-h-[360px]">
          <Image
